...
include_once ("{$base_dir}vista{$slash}mail{$slash}PHPMailerAutoload.php");
...
//        
        ...
        $mail->Username = "jesusortiz9611@gmail.com";
        $mail->Password = "chivas1111";
        $mail->SetFrom('jesusortiz9611@gmail.com', 'Miguel Ortiz González ');
        //Se agrega el asunto
        $mail->Subject = "Acceso a Barber Shop detectado";
...
<p>
     <h4>Atentamente soporte-barber shop</h4>   
</p>
</div>
</div>
